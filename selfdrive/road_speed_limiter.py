        ...
        try:
            ...
            while True:
                ...
                if server.udp_recv(sock):
                    ...
                    dat.roadLimitSpeed.nextSpeedLeftDist, dat.roadLimitSpeed.nextLimitSpeed  = next_speed_limit_and_dist(dat.roadLimitSpeed.camLimitSpeedLeftDist,dat.roadLimitSpeed.camLimitSpeed,dat.roadLimitSpeed.sectionLeftDist,dat.roadLimitSpeed.sectionLimitSpeed)
...
def next_speed_limit_and_dist(camLimitSpeedLeftDist,camLimitSpeed,sectionLeftDist,sectionLimitSpeed) :
    if camLimitSpeedLeftDist is not None and camLimitSpeed is not None and camLimitSpeedLeftDist > 0:
        return camLimitSpeedLeftDist, camLimitSpeed
    elif sectionLeftDist is not None and sectionLimitSpeed is not None and sectionLeftDist > 0 :
        return sectionLeftDist, sectionLimitSpeed
    else:
        return 0,0
